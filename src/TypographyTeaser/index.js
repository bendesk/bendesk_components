  ...
  return (
    ...
    >
        <CardContent className={classes.CardContent}>
          ...
          >
            <Button variant={buttonVariant} endIcon={<ArrowForwardIcon className={classes.arrowSize} />} style={{ color: colors[buttonTextColor], backgroundColor: buttonVariant!=='text' && colors[buttonBackground], borderRadius: '20px' }}>
              {buttonText}
            </Button>
          </div>
        </CardContent>
